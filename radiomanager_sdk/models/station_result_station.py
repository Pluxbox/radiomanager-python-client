...
class StationResultStation(object):
    ...
    openapi_types = {
        ...
        'station_key': 'str',
        'timezone': 'str',
        'metadataradio_organisation': 'str',
        'metadataradio_station_id': 'str',
    ...
    def __init__(self, id=None, name=None, created_at=None, updated_at=None, system_name=None, short_name=None, medium_name=None, website=None, email=None, keywords=None, description=None, sms=None, telephone=None, genre_id=None, language=None, active=None, logo_rectangle=None, logo_128x128=None, logo_320x320=None, logo_600x600=None, pay_off=None, pty_code=None, pty_type=None, station_key=None, timezone=None, metadataradio_organisation=None, metadataradio_station_id=None, start_days=None, local_vars_configuration=None):  # noqa: E501
        """StationResultStation - a model defined in OpenAPI"""  # noqa: E501
        ...
        self._timezone = None
        self._metadataradio_organisation = None
        self._metadataradio_station_id = None
        ...
        if metadataradio_organisation is not None:
            self.metadataradio_organisation = metadataradio_organisation
        if metadataradio_station_id is not None:
            self.metadataradio_station_id = metadataradio_station_id
    ...
    @property
    def metadataradio_organisation(self):
        """Gets the metadataradio_organisation of this StationResultStation.  # noqa: E501


        :return: The metadataradio_organisation of this StationResultStation.  # noqa: E501
        :rtype: str
        """
        return self._metadataradio_organisation

    @metadataradio_organisation.setter
    def metadataradio_organisation(self, metadataradio_organisation):
        """Sets the metadataradio_organisation of this StationResultStation.


        :param metadataradio_organisation: The metadataradio_organisation of this StationResultStation.  # noqa: E501
        :type: str
        """

        self._metadataradio_organisation = metadataradio_organisation

    @property
    def metadataradio_station_id(self):
        """Gets the metadataradio_station_id of this StationResultStation.  # noqa: E501


        :return: The metadataradio_station_id of this StationResultStation.  # noqa: E501
        :rtype: str
        """
        return self._metadataradio_station_id

    @metadataradio_station_id.setter
    def metadataradio_station_id(self, metadataradio_station_id):
        """Sets the metadataradio_station_id of this StationResultStation.


        :param metadataradio_station_id: The metadataradio_station_id of this StationResultStation.  # noqa: E501
        :type: str
        """

        self._metadataradio_station_id = metadataradio_station_id
