...
class ContactResult(object):
    ...
    def __init__(self, id=None, created_at=None, updated_at=None, deleted_at=None, external_station_id=None, model_type_id=None, field_values=None, email=None, firstname=None, lastname=None, phone=None, tags=None, items=None, model_type=None, local_vars_configuration=None):  # noqa: E501
        """ContactResult - a model defined in OpenAPI"""  # noqa: E501
