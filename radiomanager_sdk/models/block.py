...
class Block(object):
    ...
    def __init__(self, id=None, broadcast_id=None, start=None, stop=None, created_at=None, updated_at=None, deleted_at=None, external_station_id=None, local_vars_configuration=None):  # noqa: E501
