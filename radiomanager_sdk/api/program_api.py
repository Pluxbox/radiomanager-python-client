...
class ProgramApi(object):
    ...
    def list_programs_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if 'disabled' in params and params['disabled'] > 1:  # noqa: E501
            raise ValueError("Invalid value for parameter `disabled` when calling `list_programs`, must be a value less than or equal to `1`")  # noqa: E501
        if 'disabled' in params and params['disabled'] < 0:  # noqa: E501
            raise ValueError("Invalid value for parameter `disabled` when calling `list_programs`, must be a value greater than or equal to `0`")  # noqa: E501
