...
class UserApi(object):
    ...
    def delete_user_by_id_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if 'id' in params and params['id'] < 0:  # noqa: E501
            raise ValueError("Invalid value for parameter `id` when calling `delete_user_by_id`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
    ...
    def get_user_by_id_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if 'id' in params and params['id'] < 0:  # noqa: E501
            raise ValueError("Invalid value for parameter `id` when calling `get_user_by_id`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
    ...
    def invite_user_by_mail(self, data, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async'):
            ...
            (data) = self.invite_user_by_mail_with_http_info(data, **kwargs)  # noqa: E501
            return data
    ...
    def invite_user_by_mail_with_http_info(self, data, **kwargs):  # noqa: E501
        ...
        if ('data' not in params or
                params['data'] is None):
            raise ValueError("Missing the required parameter `data` when calling `invite_user_by_mail`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='InviteUserSuccess',  # noqa: E501
            auth_settings=auth_settings,
            async=params.get('async'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def list_users_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if 'page' in params and params['page'] < 0:  # noqa: E501
            raise ValueError("Invalid value for parameter `page` when calling `list_users`, must be a value greater than or equal to `0`")  # noqa: E501
        if 'limit' in params and params['limit'] > 50:  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `list_users`, must be a value less than or equal to `50`")  # noqa: E501
        if 'limit' in params and params['limit'] < 1:  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `list_users`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
