...
class ContactApi(object):
    ...
    def create_contact(self, data, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async'):
            ...
            (data) = self.create_contact_with_http_info(data, **kwargs)  # noqa: E501
            return data
    ...
    def create_contact_with_http_info(self, data, **kwargs):  # noqa: E501
        ...
        if ('data' not in params or
                params['data'] is None):
            raise ValueError("Missing the required parameter `data` when calling `create_contact`")  # noqa: E501
    ...
    def delete_contact_by_id_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if 'id' in params and params['id'] < 0:  # noqa: E501
            raise ValueError("Invalid value for parameter `id` when calling `delete_contact_by_id`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
    ...
    def get_contact_by_id_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if 'id' in params and params['id'] < 0:  # noqa: E501
            raise ValueError("Invalid value for parameter `id` when calling `get_contact_by_id`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
    ...
    def list_contacts_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if 'page' in params and params['page'] < 0:  # noqa: E501
            raise ValueError("Invalid value for parameter `page` when calling `list_contacts`, must be a value greater than or equal to `0`")  # noqa: E501
        if 'limit' in params and params['limit'] > 50:  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `list_contacts`, must be a value less than or equal to `50`")  # noqa: E501
        if 'limit' in params and params['limit'] < 1:  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `list_contacts`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def update_contact_by_id_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if 'id' in params and params['id'] < 0:  # noqa: E501
            raise ValueError("Invalid value for parameter `id` when calling `update_contact_by_id`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
