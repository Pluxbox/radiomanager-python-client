...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of radiomanager_sdk.signing.HttpSigningConfiguration
    ...
    You can programmatically set the cookie:
      conf = radiomanager_sdk.Configuration(
    ...
    Note you can use the constants defined in the radiomanager_sdk.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = radiomanager_sdk.Configuration(
        signing_info = radiomanager_sdk.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def __init__(self, host="https://radiomanager.io/api/v2",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("radiomanager_sdk")
