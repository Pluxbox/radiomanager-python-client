...
api_instance = radiomanager_sdk.StoryApi(radiomanager_sdk.ApiClient(configuration))
...
# **list_stories**
> StoryResults list_stories(page=page, model_type_id=model_type_id, tag_id=tag_id, item_id=item_id, external_station_id=external_station_id)
...
try: 
    # Get all stories.
    api_response = api_instance.list_stories(page=page, model_type_id=model_type_id, tag_id=tag_id, item_id=item_id, external_station_id=external_station_id)
    pprint(api_response)
except ApiException as e:
